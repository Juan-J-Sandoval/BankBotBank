...
def lambda_handler(event, context):
    ...
    if event["n_pregunta"] == 6:
        ...
        if respSnips['entity'] == "SYS.NOMBRE":
            respuesta = dataBot["ResponseRecluta"][n_pregunta]
            n_pregunta  += 1
        else:
        ...
        respuesta = dataBot["ResponseRecluta"][n_pregunta]
        n_pregunta  += 1
    retorna = {"respuesta": respuesta,"n_pregunta":n_pregunta, "mensaje": event["mensaje"],"estado": estado,"sessionID": event["sessionID"],"intent":"recluta"}
    return retorna
